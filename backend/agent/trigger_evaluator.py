        ...
        with sqlite3.connect(str(memory_db_file), timeout=10) as conn:
            ...
            defaults = [
                ...
                (
                    ...
                    60,
                    60,
                    "Heart rate spiked significantly above recent average. Check if this correlates with exercise or is an anomaly at rest.",
                ),
                (
                    "Activity milestone",
                    "steps",
                    ...
                    1440,
                    1440,
                    "Daily step goal of 10,000 reached! Celebrate this achievement and summarize today's activity data.",
                ),
                (
                    ...
                    240,
                    480,
                    "No heart rate data received in the last 4 hours. Check if the user's Apple Watch is being worn or if there's a data sync issue.",
                ),
            ]
