...
Supported models: gpt-4.5-preview and later (gpt-5.x onwards).
Older models (gpt-3.5, gpt-4-turbo, etc.) are not maintained here.
...
class XAIProvider(OpenAIProvider):
    """x.AI (Grok) provider."""
    def __init__(self, model: str = "grok-beta", api_key: str | None = None, **kwargs) -> None:
        super().__init__(model=model, api_key=api_key, base_url="https://api.x.ai/v1", **kwargs)


class OpenRouterProvider(OpenAIProvider):
    """OpenRouter provider."""
    def __init__(self, model: str = "anthropic/claude-3.5-sonnet", api_key: str | None = None, **kwargs) -> None:
...
class PerplexityProvider(OpenAIProvider):
    ...
    def __init__(self, model: str = "llama-3.1-sonar-huge-128k-pro", api_key: str | None = None, **kwargs) -> None:
...
class MistralProvider(OpenAIProvider):
    ...
    def __init__(self, model: str = "mistral-large-latest", api_key: str | None = None, **kwargs) -> None:
...
class MinimaxProvider(OpenAIProvider):
    ...
    def __init__(self, model: str = "abab6.5s-chat", api_key: str | None = None, **kwargs) -> None:
        # Default model updated to abab6.5s
